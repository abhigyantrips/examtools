...
export function ScheduleConfigForm({
  ...
  const updateSlotRegularDuties = useCallback(
  ...
  const handleRoomUpload = useCallback(
    async (day: number, slot: number, file: File) => {
      const key = `${day}-${slot}`;
      ...
      {dutySlots.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set dates for each day, times for each slot, then configure rooms
              and duties
            </CardDescription>
          </CardHeader>
          <CardContent>
                          ...
                          <Popover>
                            ...
                            <PopoverContent className="w-auto p-0">
                              <CalendarComponent
                                ...
                                onSelect={(date) =>
                                  date && updateDayDate(dayIndex, date)
                                }
                                required
                              />
                            </PopoverContent>
